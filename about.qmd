...
I try to use my data science skills to create algorithmic art. I published these works on this website, with some posts in <a rel="me" href="https://ecoevo.social/@casadebaig">mastodon</a>. You can also find some [examples](https://github.com/picasa/generative_examples) along with the [tools](https://github.com/picasa/generate) i used for creative coding here.
