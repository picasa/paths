...
Feel free to contact me via [email `r fontawesome::fa_i("github", verify_fa = FALSE)`](https://github.com/picasa) or [twitter `r fontawesome::fa_i("twitter", verify_fa = FALSE)`](https://twitter.com/pircasa) for any questions related to this place or if you wish to order a plotter print from a work. You can also support me through the energy-efficient tezos blockchain, where I sometimes release works with the *tz1S7NKRdKnh5SKuKpQTz3XCvpctF218ewKF* address (casadebaig.tez).
