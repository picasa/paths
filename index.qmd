...
By transforming data into ink on paper, i'm considering technology as a tool to [investigate](posts/works/statement/index.qmd), not to embrace. Sometimes the algorithm produces exactly what was expected; disappointingly predictable. Other times it generates something surprising, which can become the most interesting starting point for the next iteration.
:::
