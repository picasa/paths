...
Adding noise or removing information from the original DEM data seems to create a more natural rendering. This option was explored in the [*dispyr*](/posts/process/dispyr) series, but a simple coding example is also available [{{< fa brands github >}}](https://github.com/picasa/generative_examples). 
