...
I explained this approach a bit more in details during a talk at an art show, slides are available [here](https://github.com/picasa/slides_code_to_ink). A simple coding example is also available [{{< fa brands github >}}](https://github.com/picasa/generative_examples)
...
::: {.column-body-outset .gallery-flow .four}
```{r}
#| echo: false
#| results: asis
