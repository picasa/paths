...
The process again draws from Cozens leading ideas on imaginative landscapes (*A New Method of Assisting the Invention in Drawing Original Compositions of Landscape*, 1785), where he mentions concentrating elements otherwise "dispersed in nature". In a previous algorithm ([*dispyr*](/posts/process/dispyr)), each landscape was unequivocally linked to a piece of topographical data, and this project explores the combination of dispersed elements into an imaginative new landscapes.
...
<div> ![](img/fig_framed.jpg){.lightbox group="default"} </div>
<div> ![](img/fig_framed_detail.jpg){.lightbox group="default"} </div>
:::
...
We designed four page styles using both fixed layouts and this modular grid system: two full-page landscapes ([*brush*](/posts/process/brush) and *cloud*), and two grid layouts with (*figure*) or without legend (*partition*).
...
> From left to right, two full-page landscapes ([*brush*](/posts/process/brush) and *cloud*), and two grid layouts with (*figure*) or without legend (*partition*). These images are vector files (they only represent strokes), which is all the information needed to drive a drawing machine.
...
::: {.column-body-inset .gallery-grid}
<div> ![](img/fig_detail_a.jpg){.lightbox group="default"} </div>
<div> ![](img/fig_detail_b.jpg){.lightbox group="default"} </div>
<div> ![](img/fig_detail_c.jpg){.lightbox group="default"} </div>
<div> ![](img/fig_detail_d.jpg){.lightbox group="default"} </div>
<div> ![](img/fig_detail_e.jpg){.lightbox group="default"} </div>
<div> ![](img/fig_detail_f.jpg){.lightbox group="default"} </div>
:::
...
The final series gathers 128 works, a manual selection of 72 iterations from the *ridge regression* algorithm and 56 iterations from the previous [*brush*](/posts/process/brush) algorithm. 
