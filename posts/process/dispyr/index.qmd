...
# functions
source(here::here("R/0_rendering.r"))
source(here::here("R/0_functions_ridge.r"))
source(here::here("R/0_functions_dispyr.r"))
...
I was searching for an hybrid between the simplicity and efficiency of a famous data visualization in [astronomy](https://blogs.scientificamerican.com/sa-visual/pop-culture-pulsar-origin-story-of-joy-division-s-unknown-pleasures-album-cover-video/) and the impressive Meridian [serie](https://opensea.io/collection/meridian-by-matt-deslauriers) by Matt Deslauriers. Moreover, to be able to use a pen-plotter to trace the images on paper, the algorithm should produce relatively long lines rather than the myriad of short segments that make Meridian appealing. 

![](./img/pulses.jpg){width=300px} ![](./img/meridian_638.webp){width=300px}
...
::: {.column-screen-inset-right .gallery-grid}
```{r iterations}
#| echo: false
#| results: asis
